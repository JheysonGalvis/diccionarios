...
# Diccionario de juegos favoritos
juegos_favoritos = {
    'juego1': 'League of Legends',
    'juego2': 'Minecraft',
    'juego3': 'RDR2',
    'juego4': 'The Last of Us',
    'juego5': 'Baldurs Gate 3',
    'juego6': 'Phasmophobia'
}
...
print(juegos_favoritos.keys())
valor_asociado_a_la_clave = juegos_favoritos['juego1']
