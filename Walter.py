...
mis_bicicletas = {
    'trek': 'Verde para montaña',
    'cannondale': 'Azul para ciudad',
    'specialized': 'Negro para carretera',
    'giant': 'Rojo para carretera',
    'specialized': 'Negro para carretera'
}
...
valor_asociado_a_la_clave = mis_bicicletas['specialized']
