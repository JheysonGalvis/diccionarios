...
print(valor_asociado_a_la_clave) #Si quisiera imprimir todos las claves de mi_familia debo escribir print(mi_familia.keys())
print(mi_familia.keys()) #Pero si quiero imprimir los valores de mi_familia debo escribir print(mi_familia.values())
print(mi_familia.values())
