...
servant= servantsFateStayNight['saber']
print(f"El personaje principal es: {servant} de Fate Stay Night") #f-string en Python,  permite incluir variables dentro de una cadena de texto de manera más clara y legible. (servant)
print(servantsFateStayNight.keys())
