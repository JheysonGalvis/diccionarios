...
mi_familia = {
    'padre': "Elkin Henao",
    'madre': 'Yuri Alzate',
    'hija mayor': 'Evelyn Henao',
    'hijo medio': 'Gabriel Henao',
    'hijo menor': 'Alexandra Henao'    
}

# Acceso a elementos por clave: Accede a los elementos de un diccionario utilzando sus claves.

valor_asociado_a_la_clave1 = pokemones_de_ash['charmander']
print(valor_asociado_a_la_clave1)

valor_para_la_clave_2 = mi_familia['hija mayor']
print(valor_para_la_clave_2)
