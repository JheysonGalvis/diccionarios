...
personajes_dragon_ball= {
    'Principales': 'Goku, Vegeta , Piccolo, Krillin, Shenloong',
    'Secundarios': 'Gohan, Goten, Trunks, Broly,Freezer,Cell,Magin boo',
    'Mujeres': 'Milk, Bulma, Pam, Chirai, Videl'
}
...
valor_asociado_a_la_clave = personajes_dragon_ball ['Mujeres']
print(valor_asociado_a_la_clave)
print(personajes_dragon_ball.keys())
print (personajes_dragon_ball.values())

for clave, valor in personajes_dragon_ball.items():
    print(f"{clave} = {valor}")
