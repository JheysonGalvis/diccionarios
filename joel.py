...
marcas_autos = {
    'Ferrari': 'Deportivos de alto rendimiento y lujo italiano.',
    'Tesla': 'Vehículos eléctricos innovadores con tecnología avanzada.',
    'Mercedes-Benz': 'Lujo y comodidad con ingeniería alemana de precisión.',
    'Toyota': 'Fiabilidad y eficiencia en el consumo de combustible.',
    'Porsche': 'Alto desempeño con diseño deportivo y elegante.'
}

# Acceso a elementos por clave: Accede a los elementos de un diccionario utilzando sus claves.
valor_asociado_a_la_clave2 = marcas_autos['Ferrari']
print(valor_asociado_a_la_clave2)
print(marcas_autos.keys())
