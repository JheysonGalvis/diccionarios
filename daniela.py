...
como_se_llama_mi_mama = mi_familia['madre']
print(como_se_llama_mi_mama)

print(mi_familia.keys()) #muestra las claves o nombres del diccionario que hice osea lo que va antes de los : los dos puntos
print(mi_familia.values()) #muestra los valores o definicion del diccionario que hice osea lo que va despues de los : dos puntos.
