...
# Se imprime valor de la clave propia (maestros)
valor_clave = maestros['eddie']
print(valor_clave)
valores_claves = maestros.values() # Méetodo .values para asociar todos los valores a la variable designada
print(valores_claves)
lista_valores = list(maestros.values()) # Extrae ños valores a una lista
print(lista_valores)
