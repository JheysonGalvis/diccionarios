...
personajes_one_piece = {
    "Chef Master" : 'Sanji cocinero real',
    "Capitan" : 'Monkey D. Luffy rey de los piratas',
    "Vice Capitan" : 'Roronoa Zoro rey espadachin',
    "Navengate" : 'Nami capitana de la tripulacion'
...
valor_asociado_a_la_clave1 = personajes_one_piece['Chef Master']
print(valor_asociado_a_la_clave1)

como_se_llama_sanji = personajes_one_piece['Chef Master']    
print(como_se_llama_sanji)
print(personajes_one_piece.keis())
