...
mascotas = {
 ...
 # Accede a elementos por clave: Accede a los elementos de un diccionario utilzando sus claves.
 
valor_asociado_a_la_clave = mascotas['zarigueya']
...
#otra practica de diccionario
mis_comidas = {
    'desayuno': 'huevos con aliños',
    'almuerzo': 'frijoles con cerdo',
    'cena': 'arepa con queso'
}

print(mis_comidas['desayuno'])
valor_asociado_a_la_clave = mis_comidas['cena']
print(valor_asociado_a_la_clave)
print(mis_comidas['cena'])
