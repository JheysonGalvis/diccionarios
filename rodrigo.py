...
mis_mascotas = {
    'Canela':'Cosa de chocolate',
    'Betún':'Bebe negrito',
    'Ikki':'principe chucky',
    'Copper':'Muñequito de brownie'
}
...
# Acceso al elemento por clave - mis mascotas
valor_asociado_a_la_clave = mis_mascotas['Canela']
print(valor_asociado_a_la_clave)
print(mis_mascotas.keys())           
print(mis_mascotas.values())  
